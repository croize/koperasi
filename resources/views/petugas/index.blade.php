...
<div class="col-xs-12">
  ...
  <a href="/petugas/create"><button class="btn btn-primary">
        ...
        <tr>
          ...
          <td>
            <div class="hidden-sm hidden-xs action-buttons">
              <a class="blue" href="/petugas/{{$su->id_petugas}}">
                <i class="ace-icon fa fa-search-plus bigger-130"></i>
              </a>

              <a class="green" href="/petugas/{{$su->id_petugas}}/edit">
                <i class="ace-icon fa fa-pencil bigger-130"></i>
              </a>

              <a class="red" href="{{url('petugas/delete',$su->id_petugas)}}">
