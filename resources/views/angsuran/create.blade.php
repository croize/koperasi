...
<div class="breadcrumbs ace-save-state" id="breadcrumbs">
  <ul class="breadcrumb">
    ...
    <li class="active">Input Angsuran</li>
  </ul><!-- /.breadcrumb -->
</div>
<div class="page-header">
  ...
  <div class="col-xs-12">
    <!-- PAGE CONTENT BEGINS -->
    <form class="form-horizontal" action="/angsuran" method="post">
      {{csrf_field()}}
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          <input type="text" id="form-field-1" placeholder="Angsuran Ke" name="angsuran_ke" class="col-xs-10 col-sm-8" />
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <div class="input-group">
            <input type="text" placeholder="Tanggal Pembayaran" name="tgl_pembayaran" class="form-control col-xs-10 col-sm-8" data-toggle="datepicker"><div data-toggle="datepicker"></div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <select class="js-example-basic-single js-states form-control" name="id_katagori">
            <option value="">--SELECT--</option>
            @foreach($gar as $katagori)
            <option value="{{$katagori->id_katagori_peminjaman}}">{{$katagori->nama_pinjaman}}</option>
            @endforeach
          </select>
        </div>
      </div>
